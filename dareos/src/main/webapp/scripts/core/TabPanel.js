...
/*function show_hide_left(){
	if(window.parent.document.getElementById("midFrame").cols=="0,7,*")
	{
		...
		document.getElementById("navigation").src="/dareos/styles/newTheme/images/left/navigation_close.png";
	}
	else
	{
		window.parent.document.getElementById("midFrame").cols="0,7,*";
		document.getElementById("navigation").src="/dareos/styles/newTheme/images/left/navigation_open.png";
	}
}*/
TabPanel.prototype = {
  //初次加载渲染界面
...
/*    this.tabpanel_div = $('<DIV"></DIV>')
     this.tabpanel_div.addClass('tabpanel_mover1');
    this.tabpanel_div.appendTo(this.tabpanel_move_content)*/
//    this.tabpanel_img = $('<IMG id="navigation"  title="打开/关闭菜单栏"; src="/dareos/styles/newTheme/images/left/navigation_close.png" style="position: relative;top: 10px;left: 10px;height: 15px;width: 18px;" ></IMG>');
 //   this.tabpanel_img = $('<IMG id="navigation"  title="打开/关闭菜单栏"; src="/dareos/styles/newTheme/images/left/navigation_close.png" style="position: relative;top: 10px;left: 10px;height: 15px;width: 18px;" ></IMG>');
   /* this.tabpanel_img = $('<IMG></IMG>')*/
/*    <a href="#" data-toggle="sidebar">*/
  /* this.tabpanel_img.appendTo(this.tabpanel_div);*/
/*    this.tabpanel_a = $('<A href="#" data-toggle="sidebar"></A>');
    this.tabpanel_a.appendTo(this.tabpanel_div)
    this.tabpanel_i = $('<I class="fa-bars"></I>')
    this.tabpanel_a.addClass('tabpanel_i');
    this.tabpanel_i.appendTo(this.tabpanel_a)*/
    ...
    else if(this.scrollFinish)
    {
     ...
     /* debugger*/
      if(tabitem.id == 1){
    	  //添加title元素
        //添加选项卡LI元素
          var tab = $('<LI style="width:40px"></LI>');
          tab.attr('id', tabitem.id);
          tab.appendTo(this.tabpanel_mover);
          var title = $('<DIV></DIV>');
          var tabpanel_img = $('<IMG id="HOME" style="margin: 8px 3px;width: 20px;" title="首页"; src="/dareos/styles/newTheme/images/icon/home.png"></IMG>')
          tabpanel_img.appendTo(title)
          title.appendTo(tab);
      }else{
    	     //添加选项卡LI元素
          var tab = $('<LI ></LI>');
  ...
  show : function(position, notExecuteMoveSee){
    ...
    if(this.scrollFinish)
    {
      ...
      else
      {
        ...
        this.tabpanel_mover.find('.active').siblings().css("border-right","0.2px solid #ccd0d8");
        this.tabpanel_mover.find('.active').prev().css("border-right","none");
        for(var i = 0; i < this.tabs.length; i++){
			if(i != position){
