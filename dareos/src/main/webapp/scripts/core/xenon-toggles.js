		...
		$('a[data-toggle="sidebar"]').each(function(i, el)
		{
			$(el).on('click', function(ev)
			{
				...
				if(public_vars.$sidebarMenu.hasClass('collapsed'))
				{
					...
					$("#leftSty").css("width","180px")
					$("#iconDiv").removeClass("iconDiv")			
					$("#main-menu").addClass("overflowSty")
					$("#toggle").removeClass("toggle_open").addClass("toggle")
				}
				else
				{	
					//关闭
					...
					$("#leftSty").css("width","40px")
					var wd = (parseInt($("#grid").css("width"))-40)+'px'
					$(".rightSty").css("width",wd)
					$(".has-sub > ul").removeAttr('style')
					$(".tabpanel").css("width","")
					$("#iconDiv").addClass("iconDiv")
					$("#main-menu").removeClass("overflowSty")
					$("#toggle").removeClass("toggle").addClass("toggle_open")
					console.log($(".rightSty").css("width"))
				}
				$(window).trigger('xenon.resize');
			});
		});
