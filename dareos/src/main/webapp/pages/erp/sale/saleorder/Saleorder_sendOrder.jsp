...
<script type="text/javascript" src="${ctx}/pages/erp/sale/saleorder/Saleorder_sendOrder.js"></script>
...
<body class="bodycss1 add_demoone" style=" overflow-y:auto; overflow-x:auto;">
		...
		<table id="jsontbP"  width="100%" border="0" cellpadding="0" cellspacing="0" class="detail">
			 <tr>
				 <td class="detail2" id="toggleTable">
					<table  id="" cellspacing="0" cellpadding="0" width="98%" height="98%" id="myTable"  class="detail3"
						...
						<tr>
							<td class="detail4">
								...
								<tr>
										...
										<td class="gdtd">
											<div>订单编号：</div>
										    <input class="gdtd_select_input" json="sale_order_no"  name="SALE_ORDER_NO" label="订单编号" autocheck="true" 
									...
									<tr>
										<td class="gdtd" colspan="2">
											<div>经销商备注：</div>
											<textarea class="gdtd_textarta" json="REMARK" name="REMARK" id="REMARK"
												label="经销商备注" autocheck="true" inputtype="string" readonly
												maxlength="3000"  style="width:92.5%">${fn:replace(entry.REMARK, "；", "&#13;")}</textarea>
										</td>
										<td class="gdtd"></td>
										<td class="gdtd"></td>
									</tr>
							...
							<td class="detail4">
								<table cellspacing="0" cellpadding="0" width="98%" height="98%" id="myTable2"  class="detail3 table_detail">
									<tr>
										...
										<td class="gdtd">
											<div>经销商名称 ：</div>
											<textarea style="width: 84.5%;" rows="1"  json="chann_name" name="CHANN_NAME" id="CHANN_NAME"   READONLY>${entry.CHANN_NAME}</textarea>
									...
									<tr>
										...
										<td class="gdtd">
											<div>标签打印名称：</div>
											<textarea style="width: 188.5%;" rows="1" json="print_name" name="PRINT_NAME" id="PRINT_NAME"  READONLY>${entry.PRINT_NAME}</textarea>
										</td>
										<td class="gdtd"></td>
									</tr>
								</table>
							...
							<td class="detail4">
								<table cellspacing="0" cellpadding="0" width="98%" height="98%" id="myTable3"  class="detail3 table_detail">
									...
									<tr>
										...
										<td class="gdtd">
											<div>收货地址：</div>
											<textarea style="width: 188.5%;" rows="1"  json="recv_addr" name="RECV_ADDR" id="RECV_ADDR" >${entry.RECV_ADDR}</textarea>
										</td>
										<td class="gdtd"></td>
									</tr>
									<tr>
										<td class="gdtd">
											<div>客户姓名 ：</div>
											<input class="gdtd_select_input" json="cust_name" name="CUST_NAME"   type="text"       value="${entry.CUST_NAME}" READONLY>
										</td>
										<td class="gdtd">
											<div>客户电话：</div>
							...
							<td class="detail4">
								<table cellspacing="0" cellpadding="0" width="98%" height="98%" id="myTable4"  class="detail3  table_detail">
									<tr>
										...
										<td class="gdtd" colspan="2">
											<div>备注：</div>
											<textarea style="width: 188.5%;" rows="1"  json="REMARK2" name="REMARK2" id="REMARK2"
												label="备注" autocheck="" inputtype="string"
	...
	<div class="bodycss1 child">
		<form  autocomplete="off">
			<table width="100%" id="jsontb"  border="0" cellpadding="5" cellspacing="0" style="border-collapse: collapse;" class="lst" >
	            <tr>
	                <th nowrap align="center" ><input  type="checkbox" name="" id="allChecked"></th>
	               ...
	               <th nowrap align="center"  class="">产品名称</th>
	                ...
	                <th nowrap align="center"  class="LMM" >材质</th>
	            ...
	            <c:forEach items="${entry.entrySun}" var="rst" varStatus="row">
					...
					<tr style="height:42px;" class="list_row${r}" onmouseover="mover(this)" onmouseout="mout(this)" id="tr{rr}" ><!-- onclick="selectThis(this);setEidChecked(document.getElementById('eid${rr}'));" -->
						...
						<td nowrap align="center"  class="">
							<input size="15"  style="text-align: center;"  json="prd_no"  value="${rst.PRD_NO}"READONLY> &nbsp;
						</td>
						<td nowrap align="center" class="">
							<input size="15"  style="text-align: center;"  json="prd_name"  value="${rst.PRD_NAME}"READONLY> &nbsp;
						</td>
						<td nowrap align="center" class="LMM" >
						...
						<td nowrap align="center"  class="LMM">
							<input size="10"  style="text-align: center;"  json="prd_quality"  value="${rst.PRD_QUALITY}"READONLY> &nbsp;
						</td>
						...
						<td nowrap align="center" class="LMM" >
							<input size="10"  style="text-align: center;"  json="prd_glass"  value="${rst.PRD_GLASS}"READONLY> &nbsp;
						</td>
						<td nowrap align="center" class="LMM" >
							<input size="15"  style="text-align: center;"  json="prd_other"  value="${rst.PRD_OTHER}"READONLY> &nbsp;
						</td>
						<td nowrap align="center" class="LMM" >
							<input size="10"  style="text-align: center;"  json="prd_series"  value="${rst.PRD_SERIES}"READONLY> &nbsp;
						</td>
						...
						<td nowrap align="center" class="">
							<input size="5"  style="text-align: center;"  json="dect_rate"  value="${rst.DECT_RATE}"READONLY> &nbsp;
						</td>
						<td nowrap align="center" class="">
							<input type="text" id="REBATE_PRICE${rr}"  size="5"  json="rebate_price" name="dect_price" value="${rst.REBATE_PRICE}"  readonly="readonly">
						</td>
						<td nowrap align="center" class="">
							<input size="5"  style="text-align: center;"  json="rebate_amount"  value="${rst.REBATE_AMOUNT}"READONLY> &nbsp;
						</td>
						<td nowrap align="center" class="">
	...
	<div style="width:100%;padding:0.5%;background:#F8F8F8;text-align:center;position:fixed;bottom:0;word-spacing: 8px;">
		<button class="img_input">
			<label for='saveSendOrder'>
				<img src="${ctx}/styles/${theme}/images/icon/baocun.png" class="icon_font"> 
				<input  id="saveSendOrder" type="button"class="btn" value="保存">
			</label>
		</button>
		<button class="img_input">
	...
	<input id="errorMessage" value="${errorMessage }">
</body>
...
<script type="text/javascript">
	$(function (){
		...
		if(errorMessage!=null&&errorMessage!=""){
			showMsgPanelCloseWindow(errorMessage,'closeDialog()');
		}
		...
		//根据用户的账套信息显隐特定的字段
		var ZTMC=$("#LEDGER_ID").val();//'${entry.LEDGER_ID}';
		 changeDtlCol(ZTMC);
	});
</script>
</html>