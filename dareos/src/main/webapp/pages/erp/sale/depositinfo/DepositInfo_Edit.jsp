...
<html>
	<head>
		...
		<script type="text/javascript" src="${ctx}/pages/erp/sale/depositinfo/DepositInfo_Edit.js"></script>
		<title>充值信息编辑</title>
	<body>
										...
										<table width="100%" border="0" cellpadding="0" cellspacing="0" class="detail3">
											<tr>
												...
												<td width="35%" class="detail_content">
													<input json="depositNo" name="depositNo" id="depositNo" 
													autocheck="true"  inputtype="string" mustinput="true"  maxlength="30" readonly="readonly"
													 <c:if test="${not empty rst.depositNo}">value="${rst.depositNo}"</c:if>
													 <c:if test="${!not empty rst.depositNo}">value="自动生成"</c:if>
												...
												<td width="35%" class="detail_content">
													<select json="depositType"  name="depositType" id="depositType" type="text" autocheck="true" label="充值类型" inputtype="string" mustinput="true"   value="${rst.depositType}"></select>
												</td>
											</tr>
											<tr>
											    <td width="16%" align="right" class="detail_label">
												...
												<td width="35%" class="detail_content">
													<input id="channId" json="channId" name="channId"
											...
											<tr>
												...
												<td width="35%" class="detail_content">
													<input id="depositAmount" name="depositAmount" type="text" valueType="8,2"
														inputtype="zffloat" label="充值金额" json="depositAmount" autocheck="true" mustinput="true"
														value="${rst.depositAmount }"  >
												</td>
												<td width="16%" align="right" class="detail_label">
													附件
												</td>
												<td width="35%" class="detail_content">
													<button type="button" class="layui-btn uploadFile attPathUploader" id="attPath" lay-data="{id:'attPath'}">上传</button>
...
displayDownFile('attPath',true,false,true);
	SelDictShow("depositType","BS_210","${rst.depositType }","");
