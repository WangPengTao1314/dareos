...
<head>
    ...
    <script type="text/javascript" src="${ctx}/pages/base/chann/Chann_List_Ladger.js"></script>
</head>
<BODY>
				...
				<c:forEach items="${rst}" var="rst" varStatus="row">
					...
					<tr class="list_row${r}" onmouseover="mover(this)" onmouseout="mout(this)"  onclick="selectThis(this);setEidChecked(document.getElementById('eid${rr}'));setBtStates();">
						<td nowrap align='center' >
							<input type="checkbox" name="eid" style="height:12px;valign:middle" id="eid${rr}" value="${rst.CHANN_LEDGER_CHRG_ID}" onclick="setEidChecked(this);">
						</td>
...
<form id="form1" action="#" method="post" name="listForm">
	<input type="hidden" id="CHANN_LEDGER_CHRG_IDS" name="CHANN_LEDGER_CHRG_IDS" value=""/>
</form>
</body>
