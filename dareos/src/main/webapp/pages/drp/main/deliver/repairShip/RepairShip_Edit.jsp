...
<script type="text/javascript" src="${ctx}/pages/drp/main/deliver/repairShip/RepairShip_Edit.js"></script>
			...
			<tr>
				<td class="detail2">
						...
						<tr>
							...
							<td class="gdtd_tb">
								<div>返修单编号：</div>
							    <input class="gdtd_select_input" json="sale_order_no"  name="SALE_ORDER_NO" label="返修单编号" id="FACTORY_NO" autocheck="true" inputtype="string"  mustinput="true"
							    type="text"       value="${entry.FACTORY_NO}">
						...
						<tr>
							<td class="gdtd_tb">
									<div>运输方式 &nbsp;：</div>
									<select class="gdtd_select_input" json="transport" name="TRANSPORT" id="TRANSPORT"   type="text" disabled="true"></select>
								</td>
							<td class="gdtd_tb">
								<div>运输结算方式：</div>
								<input class="gdtd_select_input" json="transport_settle" name="TRANSPORT_SETTLE" id="TRANSPORT_SETTLE"  type="text"       value="${entry.TRANSPORT_SETTLE}" readonly="true">
							</td>
							<td class="gdtd_tb"></td>
							<td class="gdtd_tb"></td>
						</tr>
						<tr>
							...
							<td class="gdtd_tb">
								<div>收货地址：</div>
								<textarea style="width: 188.5%;height:30px;" rows="1"   json="recv_addr" name="RECV_ADDR" id="RECV_ADDR" >${entry.RECV_ADDR}</textarea>
							</td>
							<td class="gdtd_tb"></td>
						</tr>
						<tr>
							<td class="gdtd_tb">
								<div>客户姓名 ：</div>
								<input class="gdtd_select_input" json="cust_name" name="CUST_NAME"   type="text"       value="${entry.CUST_NAME}" readonly="true">
							</td>
							<td class="gdtd_tb">
								<div>客户电话：</div>
								<input class="gdtd_select_input" json="cust_tel" name="CUST_TEL" id="CUST_TEL"   type="text"       value="${entry.CUST_TEL}" readonly="true">
							</td>
							<td class="gdtd_tb">
								<div>客户地址：</div>
								<textarea style="width: 188.5%;height:30px;" rows="1"  json="cust_addr" name="CUST_ADDR" id="CUST_ADDR" readonly="true">${entry.CUST_ADDR}</textarea>
							</td>
							<td class="gdtd_tb"></td>
						</tr>
						<tr>
			...
			<table width="100%" id="jsontb"  border="0" cellpadding="5" cellspacing="0" style="border-collapse: collapse;" class="lst" >
	            ...
	            <c:forEach items="${entry.entrySun}" var="rst" varStatus="row">
					...
					<tr style="height:42px;" class="list_row${r}" onmouseover="mover(this)" onmouseout="mout(this)" id="tr{rr}" ><!--onclick="selectThis(this);setEidChecked(document.getElementById('eid${rr}'));"  -->
						...
						<td nowrap align="center"  class="">
							<input size="5"  style="text-align: center;" id="PRICE${rr}" json="price"  value="${rst.PRICE}"READONLY> &nbsp;
						</td>
						<td nowrap align="center"  class="">
							<input size="10"  style="text-align: center;" id="DECT_RATE${rr}" json="dect_rate"  value="${rst.DECT_RATE}"READONLY> &nbsp;
						</td>
						<td nowrap align="center"  class="">
