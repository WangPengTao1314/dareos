...
<head>
	...
	<title>预订单信息</title>
	<style type="text/css">
		.view td{/* border-bottom: 1px solid #D8DDE6; */}
				...
				<td class="detail2">
					<table style="width:100%;padding: 9px 0% 0;">
						<tr>
							...
							<td align="right">
								<a href="#" onclick="print()"><img src="${ctx}/styles/${theme}/images/icon/print.png" class="icon_font"></a> &nbsp;&nbsp;&nbsp;
				...
				<td class="detail2" id="myTable">
					<table cellspacing="0" cellpadding="0" class="detail3 linebreak" 
						...
						<tr>
							...
							<div>销售类型：</div>
								${rst.BILL_TYPE }
								<select class="gdtd_select_input" json="BILL_TYPE" name="BILL_TYPE" id="BILL_TYPE" style="display: none;"></select>
							</td>
							<td class="gdtd">
								<div>订货单号：</div>
								${rst.GOODS_ORDER_NO}
...
//    var iframeWin = window[window.name];
//    iframeWin.print();
// }
