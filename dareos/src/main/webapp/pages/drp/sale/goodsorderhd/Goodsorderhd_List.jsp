					...
					<table id="qxBtnTb" cellpadding="0"  cellspacing="6" border="0" width="100%" >
						<tr>
							<td nowrap  style=" word-spacing: 5px;">
								...
								<c:if test="${pvg.PVG_EDIT eq 1 or pvg.PVG_EDIT_AUDIT eq 1 }">
								...
								<button class="img_input" id="saleBackBtn" >
									<label for='saleBack'>
									<img src="${ctx}/styles/${theme}/images/icon/tuihui.png"  class="icon_font">
									<input id="saleBack" type="button" class="btn" value="退回销售订单" />
									</label>
								</button>
								</c:if>
							...
							<td nowrap style=" word-spacing: 8px; " align="right"><%-- 
								...
								<button class="img_input" style="">
									<label for='print'>
										<input id="print" type="button"onclick="parent.gotoBottomPage('${ctx}/sys/report/toGoodsOrderPrint')"  class="btn" value="打印">
									</label>
								</button>
								<button class="img_input" style="">
									<label for='export'>
		...
		<td class="detail2">
			<table width="100%" border="0" cellpadding="5" cellspacing="0" style="padding:1%">
				<tr>
					...
					<td class="gdtd_tb cx_demo">
						<div>经销商:</div>
						<input type="text" id="CHANN_NAME" name="CHANN_NAME" value="${params.CHANN_NAME}" class="gdtd_select_input cx_demo"
