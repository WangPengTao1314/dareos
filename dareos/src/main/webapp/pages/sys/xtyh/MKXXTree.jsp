...
%>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input  title="<%=SubMKAry[tempMKAryJ2]%>" id="input<%=SubMKAry[tempMKAryJ]%>"  <%if (strMK.indexOf(SubMKAry[tempMKAryJ])!=-1) {%>checked<%}%>  type="checkBox" name="checkSelB<%=MKAry[tempMKAryI]%>"  value="<%=SubMKAry[tempMKAryJ]%>" style="" ><font title="<%=SubMKAry[tempMKAryJ2]%>"><%=SubMKAry[j]+"["+SubMKAry[tempMKAryJ]+"]"%></font>
<br>
<%}%>
<%}%>
</div>
...
// 	         }
	       ...
	       var seltmp =$("#sub"+MKBH).find("input[name='checkSel']");
//            eval("seltmp=document.all('sub"+MKBH+"').all('checkSel').length");
              
           for (i=0; i<seltmp; i++) {  
        	   
	         if ($("#sub"+MKBH).find("input[name='checkSel']")[i].value.indexOf(MKBH) != -1) {
