...
<BODY>
	<table cellspacing="0" cellpadding="0" width="99.9%" height="100%" id="flash_iframe">
		<tr>
			<td id="leftiframe" width="180px">
					<iframe id="leftcontent" name="leftcontent" style="margin-left: 0px"
							 frameBorder=0 width="100%" height="100%" vspace="0px"
			...
			<td valign="top" height="95%">
				...
				<div id="bottomdiv" style="height: 45%; width: 100%">
					下帧
					<iframe id="bottomcontent" name="bottomcontent"  frameBorder=0 width="100%" height="100%" frameborder="0" scrolling="AUTO"></iframe>
				</div> -->
			</td>
		</tr>
	</table>
