...
<html>
	<head>
		...
		<script type="text/javascript" src="${ctx}/pages/sys/menu/Menu_Edit.js"></script>
		<title>菜单信息</title>
		<style>
		table tr{
		height:50px;
				...
				<tr>
					<td class="gdtd_tb cx_demo"><div>菜单编号：</div> 
						<input name="menuId" json="menuId" id="menuId" type="text" autocheck="true" mustinput="true" label="菜单编号" 
							size="30" valueType="chinese:false" inputtype="string" maxlength="6" value="${entry.MENU_ID}" READONLY>
					</td>
