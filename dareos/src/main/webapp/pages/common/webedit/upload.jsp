...
<%@ page import="com.centit.commons.edit.*"%>
<jsp:useBean id="date" scope="page" class="com.centit.commons.edit.TimeStamp"/>
  ...
  //DoSave();
   ...
   //设置上传文件类型
	...
	// Retreive the current file
		com.centit.commons.edit.File myFile = up.getFiles().getFile(i);
		if (!myFile.isMissing()) {
