...
<script type="text/javascript">
		...
		$(document).ready(function(){
			  ...
			  tabpanel = new TabPanel({
				...
				items : [{
					...
					title:'门户页面', 
					closable:false,
					html:'<iframe src="${ctx}/sys/first/toFirst" width="100%" height="100%" frameborder="0" ></iframe>'
				}]
			 });
		});
		...
		function addTab(id,name,url){
			/* 控制跳转的页面显示 */
// 		  tabpanel.addTab({id:id,title:name, html:'<iframe name="'+id+'IFrame"  id="'+id+'IFrame" width="100%" height="100%" frameborder="0" ></iframe>'});
// 		  var iframe = document.createElement(id+"IFrame"); 
// 		  $("#"+id+"IFrame")[0].onLoad(function(){
// 			  alert(1)
